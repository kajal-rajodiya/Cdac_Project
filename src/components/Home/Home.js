      ...
      <div className="card bg-dark text-white">
        ...
        <div className="card-img-overlay">
          <div className="text-center">
            <h5>
              WORK <b className="h1maintitlecolor">HARDER</b> GET{" "}
              <b className="h1maintitlecolor">STRONGER</b>
            </h5>
            <h1 className="h1maintitle">
              EASY WITH OUR <b className="h1maintitlecolor">GYM</b>
            </h1>
            {isUser ? (
              <button className="btn btn-success">Expore More</button>
            ) : (
              <Link className="btn btn-success my-2 my-sm-0" to="/signup">
                Become A Member
              </Link>
            )}
          </div>
